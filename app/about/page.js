        ...
        <div className="grid grid-cols-5 gap-x-24 gap-y-32 text-lg items-center">
            <div className="col-span-3">
                ...
                <div className="space-y-8">
                    <p>
                        Where nature&lsquo;s beauty and comfortable living blend
                        seamlessly. Hidden away in the heart of the Italian
                        Dolomites, this is your paradise away from home. But
                        it&lsquo;s not just about the luxury cabins. It&lsquo;s
                    ...
                    <p>
                        ...
                        but the real freedom and peace you&lsquo;ll find in the
                    ...
                    <p>
                        ...
                        nature&lsquo;s splendor. It&lsquo;s a place to slow
            ...
            <div className="col-span-3">
                ...
                <div className="space-y-8">
                    ...
                    <p>
                        Over the years, we&lsquo;ve maintained the essence of
                        The Wild Oasis, blending the timeless beauty of the
                        mountains with the personal touch only a family business
                        can offer. Here, you&lsquo;re not just a guest;
                        you&lsquo;re part of our extended family. So join us at
